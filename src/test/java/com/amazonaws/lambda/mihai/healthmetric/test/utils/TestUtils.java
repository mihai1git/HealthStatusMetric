...
//        dynamodbEventMapper.addMixIn(AttributeValue.class, DynamodbEventMixin.AttributeValueMixIn.class);
    ...
    public static String readFromProjectResource(String fileName) throws IOException {
    	InputStream inputStream = readStreamFromProjectResource(fileName);
    	return TestUtils.readFromInputStream(inputStream);	
    }
    
    public static InputStream readStreamFromProjectResource(String fileName) throws IOException {
    ...
    public static <T> T parse(String resource, Class<T> clazz)
        ...
        try {
            if (clazz == S3Event.class) {
                ...
                S3EventNotification event = null;// S3EventNotification.parseJson(json);
